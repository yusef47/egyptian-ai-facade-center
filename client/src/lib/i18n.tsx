...
export const en = {
  ...
  "studio.desc":
    "Upload the current facade, choose a heritage style, describe the restoration, and let the engine rebuild it with architectural precision.",
  ...
  "studio.outputTitle": "Restored Facade — 8K",
  "studio.outputEmpty": "Your restored 8K facade will appear here.",
...
export const ar: Record<TranslationKey, string> = {
  ...
  "studio.desc":
    "ارفع الواجهة الحالية، اختر طرازاً تراثياً، صِف الترميم المطلوب، ودع المحرك يعيد بناءها بدقة معمارية.",
  ...
  "studio.outputTitle": "الواجهة المرممة — 8K",
  "studio.outputEmpty": "ستظهر الواجهة المرممة 8K هنا.",
