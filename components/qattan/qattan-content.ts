...
const toolsEn: QattanTool[] = [
  ...
  { id: "engineering", title: "Engineering Multiview & 3D", description: "Deduce 3D isometric views and complete orthographic projections from a single 2D view.", status: "live", href: "/studio?mode=engineering", features: ["From one view to all projections", "Engineering-grade precision"] },
];
...
const toolsAr: QattanTool[] = [
  ...
  { id: "engineering", title: "الاستنتاج الهندسي", description: "استنتج المنظور ثلاثي الأبعاد والمساقط الثلاثة الكاملة من مسقط واحد فقط.", status: "live", href: "/studio?mode=engineering", features: ["من مسقط واحد لكل المساقط", "دقة هندسية أكاديمية"] },
];
...
export const qattanCopy: Record<QattanLocale, QattanCopy> = {
  en: {
    ...
    tools: { eyebrow: "The Qattan toolkit", title: "AI design tools.", description: "Nine live engines share one workspace and one server-side image pipeline. Pick a tool, upload your source, and control the output with architectural presets.", live: "Live now", planned: "Planned", open: "Open tool", preview: "Watch preview", items: toolsEn },
  ...
  ar: {
    ...
    tools: { eyebrow: "مجموعة أدوات قطان", title: "أدوات الذكاء الاصطناعي للتصميم", description: "تسعة محركات حية في مساحة واحدة ومسار صور واحد على الخادم. اختر الأداة، ارفع مصدرك، وتحكم في المخرجات بضبط معماري.", live: "متاح الآن", planned: "مخطط", open: "فتح الأداة", preview: "شاهد المعاينة", items: toolsAr },
    ...
    faq: { eyebrow: "أسئلة", title: "بداية واضحة لفريقك.", items: [{ question: "ماذا يمكنني توليده الآن؟", answer: "الأدوات التسع كلها حية: الواجهات مع وضع الترميم التراثي، الداخلية، الاسكتش، الماستر بلان، المناظر الطبيعية، التأثيث الافتراضي، تحسين الرندر، تحويل المخطط إلى كاد مع تصدير DXF محلياً، والاستنتاج الهندسي — كلها عبر محرك الصور المشترك على الخادم." }, { question: "هل المخرجات مستندات تنفيذية؟", answer: "لا. المخرجات دراسات بصرية مفاهيمية. يجب أن يراجع المختصون المرخصون الأبعاد والإنشاء والخامات والكود والتراخيص." }, { question: "هل أحتاج إلى حساب؟", answer: "ليس في هذه المعاينة. تحفظ الجلسة داخل المتصفح وقد تختفي عند التحديث؛ الحسابات الدائمة مؤجلة." }, { question: "هل يصدّر قطان DWG؟", answer: "يصدّر المسار الحالي ملفات DXF نصية قابلة للتحرير. يستطيع AutoCAD فتح DXF وحفظه بصيغة DWG عند الحاجة." }, { question: "هل الأدوات الأخرى حية؟", answer: "كل أداة في المجموعة محرك حي يعمل عبر محرك قطان المعماري على الخادم مع برومبتات معمارية مخصصة لكل أداة." }] },
