...
export const qattanCopy: Record<QattanLocale, QattanCopy> = {
  en: {
    ...
    tools: { eyebrow: "The Qattan toolkit", title: "AI design tools.", description: "Eight live engines share one workspace and one server-side image pipeline. Pick a tool, upload your source, and control the output with architectural presets.", live: "Live now", planned: "Planned", open: "Open tool", items: toolsEn },
  ...
  ar: {
    ...
    tools: { eyebrow: "مجموعة أدوات قطان", title: "أدوات الذكاء الاصطناعي للتصميم", description: "ثمانية محركات حية في مساحة واحدة ومسار صور واحد على الخادم. اختر الأداة، ارفع مصدرك، وتحكم في المخرجات بضبط معماري.", live: "متاح الآن", planned: "مخطط", open: "فتح الأداة", items: toolsAr },
