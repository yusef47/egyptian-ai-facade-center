...
const toolsEn: QattanTool[] = [
  { id: "exterior", title: "Exterior AI", description: "Explore facade materials, massing, and daylight direction.", status: "planned", href: "/studio?mode=exterior" },
  { id: "interior", title: "Interior AI", description: "Shape interior atmospheres, finishes, and furniture studies.", status: "planned", href: "/studio?mode=interior" },
  { id: "sketch", title: "Sketch to Image", description: "Turn early lines and diagrams into visual concept studies.", status: "planned", href: "/studio?mode=sketch" },
  { id: "masterplan", title: "Masterplan AI", description: "Translate site ideas into coherent urban design directions.", status: "planned", href: "/studio?mode=masterplan" },
  { id: "landscape", title: "Landscape AI", description: "Test planting, public realm, and landscape atmospheres.", status: "planned", href: "/studio?mode=landscape" },
  { id: "staging", title: "Virtual Staging", description: "Explore furnishing options for architectural presentation images.", status: "planned", href: "/studio?mode=staging" },
  { id: "enhancer", title: "Render Enhancer", description: "Prepare a sharper presentation direction for future 4K workflows.", status: "planned", href: "/studio?mode=enhancer" },
  { id: "facade", title: "Facade Restoration", description: "Generate one coordinated architectural triptych from a facade image.", status: "live", href: "/studio?mode=facade" },
  { id: "cad", title: "Floor Plan to CAD", description: "Generate four architectural views and export local DXF files.", status: "live", href: "/studio?mode=cad" },
];

const toolsAr: QattanTool[] = [
  { id: "exterior", title: "الواجهات بالذكاء الاصطناعي", description: "استكشف خامات الواجهات والكتل واتجاهات ضوء النهار.", status: "planned", href: "/studio?mode=exterior" },
  { id: "interior", title: "التصميم الداخلي", description: "شكّل أجواء الفراغات والتشطيبات ودراسات الأثاث.", status: "planned", href: "/studio?mode=interior" },
  { id: "sketch", title: "من الاسكتش إلى الصورة", description: "حوّل الخطوط والمخططات الأولية إلى دراسات بصرية.", status: "planned", href: "/studio?mode=sketch" },
  { id: "masterplan", title: "الماستر بلان", description: "ترجم أفكار الموقع إلى اتجاهات عمرانية متماسكة.", status: "planned", href: "/studio?mode=masterplan" },
  { id: "landscape", title: "المناظر الطبيعية", description: "اختبر الزراعة والفراغ العام وأجواء الموقع.", status: "planned", href: "/studio?mode=landscape" },
  { id: "staging", title: "التأثيث الافتراضي", description: "استكشف خيارات التأثيث لصور العرض المعماري.", status: "planned", href: "/studio?mode=staging" },
  { id: "enhancer", title: "تحسين الرندر", description: "جهّز اتجاهاً أوضح لمسارات العرض عالية الدقة مستقبلاً.", status: "planned", href: "/studio?mode=enhancer" },
  { id: "facade", title: "ترميم الواجهات", description: "ولّد تريبتيكاً معمارياً متناسقاً من صورة واجهة واحدة.", status: "live", href: "/studio?mode=facade" },
  { id: "cad", title: "تحويل المخطط إلى كاد", description: "ولّد أربعة رسومات معمارية وصدّر ملفات DXF محلياً.", status: "live", href: "/studio?mode=cad" },
];
...
export const qattanCopy: Record<QattanLocale, QattanCopy> = {
  en: {
    ...
    tools: { eyebrow: "The Qattan toolkit", title: "One workspace for the visual decisions that matter.", description: "Live tools are available today; planned tools show the direction of the platform without pretending to be separate production pipelines.", live: "Live now", planned: "Planned", open: "Open tool", items: toolsEn },
    ...
    pricing: { eyebrow: "Access", title: "Start with the workflow, scale with the studio.", description: "The Qattan account and credit system is being prepared separately. This prototype keeps generation server-side and does not collect payment.", badge: "Private preview", details: ["Facade triptych generation", "Four-view CAD image generation", "Local DXF and ZIP export", "Professional review disclaimer"], action: "Open the studio" },
    faq: { eyebrow: "Questions", title: "A clear starting point for your team.", items: [{ question: "What can I generate today?", answer: "The live prototype supports facade restoration triptychs and a four-quadrant floor-plan-to-CAD workflow through the shared image engine." }, { question: "Are the outputs construction documents?", answer: "No. Outputs are conceptual visual studies. Dimensions, structure, materials, code compliance, and permissions must be reviewed by licensed professionals." }, { question: "Do I need an account?", answer: "Not in this preview slice. Session history is held in the browser and can be lost on refresh; persistent accounts are deferred." }, { question: "Can Qattan export DWG?", answer: "The live browser workflow exports editable ASCII DXF files. AutoCAD can open a DXF and save it as DWG when your team is ready." }, { question: "Are the other tools live?", answer: "Exterior, interior, sketch, masterplan, landscape, staging, and enhancer cards are planned showcase modes in this slice." }] },
  ...
  ar: {
    ...
    tools: { eyebrow: "مجموعة أدوات قطان", title: "مساحة واحدة للقرارات البصرية المهمة.", description: "الأدوات الحية متاحة الآن، أما الأدوات المخططة فتوضح اتجاه المنصة من دون ادعاء وجود مسارات إنتاج منفصلة.", live: "متاح الآن", planned: "مخطط", open: "فتح الأداة", items: toolsAr },
    ...
    pricing: { eyebrow: "الوصول", title: "ابدأ بمسار العمل وتوسع مع الاستوديو.", description: "يجري إعداد نظام الحسابات والأرصدة في قطان بشكل منفصل. هذه النسخة لا تجمع أي مدفوعات وتبقي التوليد على الخادم.", badge: "معاينة خاصة", details: ["توليد تريبتيك الواجهات", "توليد أربع مشاهد للكاد", "تصدير DXF وZIP محلياً", "تنبيه المراجعة المهنية"], action: "افتح الاستوديو" },
    faq: { eyebrow: "أسئلة", title: "بداية واضحة لفريقك.", items: [{ question: "ماذا يمكنني توليده الآن؟", answer: "تدعم النسخة الحالية تريبتيك ترميم الواجهات ومسار تحويل المخطط إلى صورة رباعية للكاد عبر محرك الصور المشترك." }, { question: "هل المخرجات مستندات تنفيذية؟", answer: "لا. المخرجات دراسات بصرية مفاهيمية. يجب أن يراجع المختصون المرخصون الأبعاد والإنشاء والخامات والكود والتراخيص." }, { question: "هل أحتاج إلى حساب؟", answer: "ليس في هذه المعاينة. تحفظ الجلسة داخل المتصفح وقد تختفي عند التحديث؛ الحسابات الدائمة مؤجلة." }, { question: "هل يصدّر قطان DWG؟", answer: "يصدّر المسار الحالي ملفات DXF نصية قابلة للتحرير. يستطيع AutoCAD فتح DXF وحفظه بصيغة DWG عند الحاجة." }, { question: "هل الأدوات الأخرى حية؟", answer: "أدوات الواجهات والداخلية والاسكتش والماستر بلان والمناظر الطبيعية والتأثيث والتحسين مخططة في هذه المرحلة." }] },
