...
export const qattanCopy: Record<QattanLocale, QattanCopy> = {
  ...
  ar: {
    ...
    faq: { eyebrow: "أسئلة", title: "بداية واضحة لفريقك.", items: [{ question: "ماذا يمكنني توليده الآن؟", answer: "الأدوات الثماني كلها حية: الواجهات مع وضع الترميم التراثي، الداخلية، الاسكتش، الماستر بلان، المناظر الطبيعية، التأثيث الافتراضي، تحسين الرندر، وتحويل المخطط إلى كاد مع تصدير DXF محلياً — كلها عبر محرك الصور المشترك على الخادم." }, { question: "هل المخرجات مستندات تنفيذية؟", answer: "لا. المخرجات دراسات بصرية مفاهيمية. يجب أن يراجع المختصون المرخصون الأبعاد والإنشاء والخامات والكود والتراخيص." }, { question: "هل أحتاج إلى حساب؟", answer: "ليس في هذه المعاينة. تحفظ الجلسة داخل المتصفح وقد تختفي عند التحديث؛ الحسابات الدائمة مؤجلة." }, { question: "هل يصدّر قطان DWG؟", answer: "يصدّر المسار الحالي ملفات DXF نصية قابلة للتحرير. يستطيع AutoCAD فتح DXF وحفظه بصيغة DWG عند الحاجة." }, { question: "هل الأدوات الأخرى حية؟", answer: "كل أداة في المجموعة محرك حي يعمل عبر محرك قطان المعماري على الخادم مع برومبتات معمارية مخصصة لكل أداة." }] },
