...
export const en = {
  ...
  "cad.title": "From colored plan to editable CAD linework",
  "cad.desc": "Convert a colored 2D or 3D floor plan into clean black-and-white drafting line art, then export raster-derived polylines as an editable DXF.",
  ...
  "cad.convertButton": "Convert to B&W CAD LineArt",
  "cad.convertLoading": "Converting to CAD line art…",
  "cad.outputTitle": "Generated B&W CAD Line Art",
  "cad.outputEmpty": "Your cleaned 2D black-and-white floor plan will appear here.",
  "cad.downloadButton": "Download AutoCAD File (.dxf)",
  "cad.downloadLoading": "Preparing DXF…",
  "cad.downloadHint": "Editable ASCII DXF for AutoCAD 2024 · raster-derived geometry",
  "cad.reviewNote": "Review dimensions, wall thicknesses, openings, and layers with a licensed architect before construction use.",
  "cad.statusUploaded": "Floor plan uploaded. Convert it to CAD line art when ready.",
  "cad.statusComplete": "B&W CAD line art is ready for DXF export.",
...
export const ar: Record<TranslationKey, string> = {
  ...
  "cad.title": "من مخطط ملون إلى خطوط كاد قابلة للتحرير",
  "cad.desc": "حوّل المخطط المعماري ثنائي أو ثلاثي الأبعاد إلى خطوط رسم أبيض وأسود نظيفة، ثم صدّر المسارات المستخرجة من الصورة كملف DXF قابل للتحرير.",
  ...
  "cad.convertButton": "✨ تحويل إلى نمط كاد أبيض وأسود",
  "cad.convertLoading": "جارٍ التحويل إلى خطوط كاد…",
  "cad.outputTitle": "الخطوط المولدة بنمط كاد أبيض وأسود",
  "cad.outputEmpty": "سيظهر هنا المخطط ثنائي الأبعاد بعد تنظيفه وتحويله إلى أبيض وأسود.",
  "cad.downloadButton": "📥 تحميل ملف AutoCAD (DXF)",
  "cad.downloadLoading": "جارٍ تجهيز ملف DXF…",
  "cad.downloadHint": "ملف DXF نصي قابل للتحرير في AutoCAD 2024 · هندسة مستخرجة من الصورة",
  "cad.reviewNote": "يرجى مراجعة الأبعاد وسماكات الحوائط والفتحات والطبقات مع معماري مرخص قبل استخدامه في التنفيذ.",
  "cad.statusUploaded": "تم رفع المخطط. يمكنك تحويله إلى خطوط كاد عند الاستعداد.",
  "cad.statusComplete": "الخطوط البيضاء والسوداء جاهزة لتصدير DXF.",
